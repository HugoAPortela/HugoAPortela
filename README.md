...
Apredendo Constantemente para ser um Desenvolvedor Full Stack | Python, C#, SQL, HTML, CSS, JavaScript\
Técnologo em Análise e Desenvolvimento de Sistemas (PITAGORAS).

Desde 2018 e Formando em 2020, venho aprofundando meus estudos em desenvolvimento de software e me apaixonei pela possibilidade de criar soluções do zero, utilizando apenas código . Além disso, possuo experiência com Inteligência Artificial , explorando soluções com Microsoft Copilot, Google Gemini e ChatGPT para automação, análise de dados e otimização de processos.
